...
<head>
    ...
    <meta name="description" content="Portail français du GBIF"/>
    <meta name="author" content="GBIF France">
    ...
    <link href="http://layout.gbiftogo.org/picture/favicon.ico" rel="shortcut icon"  type="image/x-icon"/>

    <title><g:layoutTitle /></title>
    <g:render template="/layouts/global" plugin="biocache-hubs"/>

    <asset:stylesheet src="alt.css" />
    <asset:javascript src="alt.js" />
